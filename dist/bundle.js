...
function HTube() {
    ...
    function setupUI() {
        ...
        _settingUI = new __WEBPACK_IMPORTED_MODULE_0__interface_js__["a" /* default */]();
...
function ControlSetting() {
    ...
    function enableReplay() {
        ...
        __WEBPACK_IMPORTED_MODULE_0__helper_js__["a" /* default */].triggerEvent(_controlContainer, "setting:replayChange", {
            state: true
        });
    }
    ...
    function enableTimer() {
        ...
        __WEBPACK_IMPORTED_MODULE_0__helper_js__["a" /* default */].triggerEvent(_controlContainer, "setting:timeChange", {
            timer: true
        });
    }
    ...
    this.Create = function () {
        ...
        if (_controlContainer) {
            ...
            __WEBPACK_IMPORTED_MODULE_0__helper_js__["a" /* default */].prepend(ytContainer, __WEBPACK_IMPORTED_MODULE_0__helper_js__["a" /* default */].createElement(htmlTemplate));
            _controlContainer = ytContainer.querySelector(".htube");
            selectElements();
